...
- 🤖 مساعد عائم: زر على أي موقع يفتح شات Gemini بمهامك الحية (تذكير/تشجيع/إضافة مهام بالأمر) + تشغيل/إيقاف من ⚙️ (يطلب إذن المواقع مرة واحدة، بدون تحذير تسطيب) + سحب الزر لأي مكان + 8 أيقونات و6 ألوان وشكلين من التخصيص
