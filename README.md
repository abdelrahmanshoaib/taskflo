...
- 🤖 مساعد عائم: زر على أي موقع يفتح شات Gemini بمهامك الحية (تذكير/تشجيع/إضافة مهام بالأمر) + تشغيل/إيقاف من ⚙️ (يطلب إذن المواقع مرة واحدة، بدون تحذير تسطيب) + سحب الزر لأي مكان + 8 أيقونات و6 ألوان وشكلين من التخصيص + ⚙️ تخصيص الشات نفسه (خطوط عربية/حجم/فاتح-داكن-مخصص/ألوان الخلفية والرسائل) مع وضوح أعلى (اتجاه تلقائي وتباعد مريح) + **محادثة واحدة مشتركة بين كل المواقع** + **⏰ نبّه تلقائي** (تذكير/تشجيع دوري كل 15/30/60/120د بإشعار + رسالة + نقطة غير مقروء على الزر)
